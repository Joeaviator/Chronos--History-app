...
const firebaseConfig = {
  apiKey: import.meta.env.VITE_FIREBASE_API_KEY || (process?.env?.VITE_FIREBASE_API_KEY) || firebaseConfigData.apiKey,
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || (process?.env?.VITE_FIREBASE_AUTH_DOMAIN) || firebaseConfigData.authDomain,
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || (process?.env?.VITE_FIREBASE_PROJECT_ID) || firebaseConfigData.projectId,
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || (process?.env?.VITE_FIREBASE_STORAGE_BUCKET) || firebaseConfigData.storageBucket,
  messagingSenderId: import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID || (process?.env?.VITE_FIREBASE_MESSAGING_SENDER_ID) || firebaseConfigData.messagingSenderId,
  appId: import.meta.env.VITE_FIREBASE_APP_ID || (process?.env?.VITE_FIREBASE_APP_ID) || firebaseConfigData.appId,
  firestoreDatabaseId: import.meta.env.VITE_FIREBASE_FIRESTORE_DATABASE_ID || (process?.env?.VITE_FIREBASE_FIRESTORE_DATABASE_ID) || (firebaseConfigData as any).firestoreDatabaseId
};

// Debug environment variable detection - This will show in the browser console
console.log('Firebase Config Debug:', {
  source: 'direct-access',
  apiKeyDetected: !!import.meta.env.VITE_FIREBASE_API_KEY,
  authDomainDetected: !!import.meta.env.VITE_FIREBASE_AUTH_DOMAIN,
  projectIdDetected: !!import.meta.env.VITE_FIREBASE_PROJECT_ID,
